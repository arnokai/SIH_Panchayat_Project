...
This README is intentionally focused on **what V2 adds and how V2 works**. Earlier model experiments remain useful as development history, but they are not repeated here in full.
...
test_advisory_context.py
test_advisory_rules.py
test_forecast_advisories.py
```
...
models/v2_downscaling_rain_classifier.pkl
...
V2 includes focused advisory/context tests:
